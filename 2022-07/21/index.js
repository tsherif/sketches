...
Module['FS_createPath']("/", "audio", true, true);
    ...
    loadPackage({"files": [{"filename": "/audio/music.wav", "start": 0, "end": 26867586, "audio": 1}], "remote_package_size": 26867586});
...
var INITIAL_MEMORY = Module['INITIAL_MEMORY'] || 58982400;legacyModuleProp('INITIAL_MEMORY', 'INITIAL_MEMORY');
...
assert(INITIAL_MEMORY == 58982400, 'Detected runtime INITIAL_MEMORY setting.  Use -sIMPORTED_MEMORY to define wasmMemory dynamically');
...
function createWasm() {
  ...
  function receiveInstance(instance, module) {
    ...
    //assert(wasmMemory.buffer.byteLength === 58982400);
